...
button_clear = tkinter.Button(root, text="Clear", padx=123.99, pady=20, command=button_clear).grid(row=1, column=1, columnspan=3)
...
button_subtract = tkinter.Button(root, text="-", padx=31, pady=20, command=button_subtract).grid(row=2, column=4)
...
button_multiply = tkinter.Button(root, text="÷", padx=30, pady=20, command=button_divide).grid(row=4, column=4)
